...
class Loader extends ResourceFormatLoader:
	...
	func _load(path: String, _original_path: String, _use_sub_threads: bool, _cache_mode: int) -> Variant:
		...
		cfg.enable_deep_mods = file.get_value(SECTION_SYSTEM, KEY_ENABLE_DEEP_MODS, DEFAULT_ENABLE_DEEP_MODS)
...
class Saver extends ResourceFormatSaver:
	...
	func _save(resource: Resource, path: String, _flags: int) -> Error:
		...
		file.set_value(SECTION_SYSTEM, KEY_ENABLE_DEEP_MODS, cfg.enable_deep_mods)
